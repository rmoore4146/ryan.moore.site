...
public class ChallengeControllerTest {
	...
	public void homePageMobileSitePreference() {
		...
		assertEquals("challenge", controller.challenge(SitePreference.MOBILE, model));
	}
	
	@Test
	public void homePageTabletSitePreference() {
		Model model = new ExtendedModelMap();
		assertEquals("challenge", controller.challenge(SitePreference.TABLET, model));
	}

	@Test
	public void homePageNormalSitePreference() {
		Model model = new ExtendedModelMap();
		assertEquals("challenge", controller.challenge(SitePreference.NORMAL, model));
	}
